      ...
      <div className="w-full max-w-sm bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="p-6">
          <div className="text-center mb-5">
            ...
            <p className="mt-1 text-xs text-gray-600">Sign in to your account</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="w-full px-3 py-2 text-sm border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-200"
                value={email}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full py-2 px-3 text-sm rounded font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:ring-offset-1 transition-all duration-200 ${
