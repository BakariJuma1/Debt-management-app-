...
const CustomerManagement = () => {
  ...
  return (
    <Layout>
      <div className="p-4 bg-gray-50 min-h-screen md:ml-10 md:mt-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
            ...
            {canEdit() && (
              <button
                className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center transition duration-200 w-full sm:w-auto justify-center"
                    ...
                    <div className="p-4 md:p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-10 w-10 md:h-12 md:w-12 bg-blue-100 rounded-full flex items-center justify-center">
                            <FiUser className="h-5 w-5 md:h-6 md:w-6 text-blue-600" />
                          </div>
                          <div className="ml-3 md:ml-4">
                            ...
                            <p className="text-xs md:text-sm text-gray-500 flex items-center mt-1">
                              <FiPhone className="mr-1 md:mr-2 h-3 w-3 md:h-4 md:w-4" />{" "}
                              {customer.phone}
                            </p>
                            {customer.email && (
                              <p className="text-xs md:text-sm text-gray-500 flex items-center mt-1">
                        ...
                        <button
                          ...
                          className="text-gray-400 hover:text-gray-600 transition-colors duration-150 ml-2"
                        >
                        ...
                        <div className="flex space-x-1 md:space-x-2">
                          {canEdit() && (
                            <button
                              ...
                              className="text-indigo-600 hover:text-indigo-800 p-1 md:p-2 rounded-full hover:bg-indigo-50 transition duration-150"
                              title="Edit customer"
                            >
                              <FiEdit className="h-4 w-4 md:h-4 md:w-4" />
                            </button>
                          )}
                          {canDelete() && (
                            <button
                              onClick={() => handleDelete(customer)}
                              className="text-red-600 hover:text-red-800 p-1 md:p-2 rounded-full hover:bg-red-50 transition duration-150"
                              title="Delete customer"
                            >
                              <FiTrash2 className="h-4 w-4 md:h-4 md:w-4" />
                            </button>
                          )}
                        </div>
                      ...
                      <div className="border-t border-gray-200 bg-gray-50 p-4 md:p-6">
                        ...
                        {loadingDebts[customer.id] ? (
                          ...
                          <div className="text-center py-4 text-gray-500">
                            <FiDollarSign className="h-6 w-6 md:h-8 md:w-8 mx-auto text-gray-300 mb-2" />
                          ...
                          <div className="space-y-3">
                            {debts.map((debt) => {
                              ...
                              return (
                                <div
                                  key={debt.id}
                                  className="bg-white rounded-lg p-3 md:p-4 shadow-xs border border-gray-100"
                                >
                                  ...
                                  <div className="mt-2 md:mt-3 mb-4 md:mb-6">
                                    <h5 className="text-xs md:text-sm font-semibold text-gray-800 mb-2 flex items-center">
                                      <FiList className="mr-1 h-3 w-3 md:h-4 md:w-4" />
                                      Items Taken
                                    </h5>
                                    {debt.items && debt.items.length > 0 ? (
                                      <ul className="list-disc pl-4 md:pl-5 text-xs md:text-sm text-gray-700">
                                        {debt.items.map((item) => (
                                  ...
                                  <div className="grid grid-cols-3 gap-3 md:gap-4 text-xs md:text-sm mb-3">
                                    <div>
                                  ...
                                  {balance > 0 && (
                                    <div className="flex justify-end">
                                      <button
                                        ...
                                        className="text-indigo-600 hover:text-indigo-800 text-xs md:text-sm font-medium flex items-center disabled:opacity-50"
                                      >
