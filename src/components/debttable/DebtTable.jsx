...
${paymentList || "No payments yet."}
 ...
 Summary generated on ${new Date().toLocaleDateString()}`);
  ...
  return (
    <Layout>
      <div className="container mx-auto p-3 md:p-4 max-w-6xl md:mt-8">
        {/* Header Section */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 mb-6 md:mb-8">
          <div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transition-all hover:shadow-md">
